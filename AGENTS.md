...
- Keep access invite-only and fail closed. Verify identities server-side, then check the current active leadership profile. Never authorize from user-editable metadata or an unverified session cookie.
